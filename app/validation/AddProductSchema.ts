...
export const productSchema = yup.object({
  ...
  variations: yup
    ...
    .test(
      ...
      "At least one variation is required for variant products",
      function (value) {
    ...
    .of(
      yup.object({
        ...
        price_after_discount: yup
          ...
          .required("Variation price after discount is required"),
  ...
  price_after_discount: yup
    ...
    .test(
      "required-if-no-variation",
      "Price after discount is required for non-variant products",
      function (value) {
        const { has_variation } = this.parent;
        return has_variation || !!value;
      }
  ...
  stock: yup
    ...
    .test(
      "required-if-no-variation",
      "Stock is required for non-variant products",
      function (value) {
        const { has_variation } = this.parent;
        return has_variation || !!value;
      }
